...
class TestMovementManager:
    ...
    @pytest.fixture
    def movement_manager(self, mock_world_state_manager, mock_location_service, mock_physics_engine):
    ...
    @pytest.mark.asyncio
    async def test_process_movement_command_success(self, movement_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_process_movement_command_invalid_direction(self, movement_manager, sample_context):
    ...
    async def test_validate_movement_success(self, movement_manager, sample_context):
        ...
        is_valid, error = await movement_manager.validate_movement(
            "forest_clearing", "forest_clearing_north", sample_context.get("player_state", {})
        )
    ...
    async def test_apply_movement_effects(self, movement_manager, sample_context):
        ...
        from game_loop.core.command_handlers.physical_action_processor import PhysicalActionResult, PhysicalActionType
        ...
        result = await movement_manager.apply_movement_effects("player_1", movement_result)
    ...
    async def test_check_location_events(self, movement_manager, sample_context):
        ...
        events = await movement_manager._check_location_events("test_location", "player_1")
    ...
    async def test_get_location_obstacles(self, movement_manager, sample_context):
        ...
        obstacles = await movement_manager._get_location_obstacles("test_location", "north")
    ...
    async def test_get_movement_required_items(self, movement_manager, sample_context):
        ...
        items = await movement_manager._get_movement_required_items("test_location", "north")
