...
class TestCraftingManager:
    ...
    def crafting_manager(self):
        ...
        skill_manager = Mock()
        skill_manager.get_skills = AsyncMock(
            return_value={"smithing": 5, "crafting": 3}
        )

        physics_engine = Mock()

        manager = CraftingManager(
            object_manager, inventory_manager, skill_manager, physics_engine
        )
        return manager
    ...
    @pytest.mark.asyncio
    async def test_start_crafting_session_missing_components(
        self, crafting_manager, basic_recipe
    ):
    ...
    async def test_process_crafting_step(self, crafting_manager, basic_recipe):
        ...
        step_result = await crafting_manager.process_crafting_step(
            session_id, {"difficulty": 1.0, "tool_quality": 0.8}
        )
    ...
    async def test_process_crafting_step_invalid_session(self, crafting_manager):
        ...
        step_result = await crafting_manager.process_crafting_step(
            "invalid_session", {"difficulty": 1.0}
        )
    ...
    @pytest.mark.asyncio
    async def test_complete_crafting_session_success(
        self, crafting_manager, basic_recipe
    ):
        ...
        # Complete session
        success, completion_result = await crafting_manager.complete_crafting_session(
            session_id
        )
    ...
    @pytest.mark.asyncio
    async def test_complete_crafting_session_not_ready(
        self, crafting_manager, basic_recipe
    ):
    ...
    async def test_cancel_crafting_session(self, crafting_manager, basic_recipe):
        ...
        cancellation_result = await crafting_manager.cancel_crafting_session(
            session_id, recovery_percentage=0.8
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_crafting_requirements_success(
        self, crafting_manager, basic_recipe
    ):
        ...
        crafting_manager._get_available_tools = AsyncMock(
            return_value=["hammer", "anvil"]
        )
        crafting_manager._get_available_crafting_stations = AsyncMock(
            return_value=["forge"]
        )
        ...
        is_valid, errors = await crafting_manager.validate_crafting_requirements(
            "basic_sword", "player1", {"iron_ingot": 2, "wood_handle": 1}
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_crafting_requirements_insufficient_skill(
        self, crafting_manager, basic_recipe
    ):
        ...
        crafting_manager._get_crafter_skills = AsyncMock(
            return_value={"smithing": 1}
        )  # Need 3
        crafting_manager._get_available_tools = AsyncMock(
            return_value=["hammer", "anvil"]
        )
    ...
    @pytest.mark.asyncio
    async def test_validate_crafting_requirements_missing_tools(
        self, crafting_manager, basic_recipe
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_crafting_success_probability(
        self, crafting_manager, basic_recipe
    ):
        ...
        probability = await crafting_manager.calculate_crafting_success_probability(
            "basic_sword", crafter_skills, component_quality
        )
    ...
    @pytest.mark.asyncio
    async def test_calculate_crafting_success_probability_low_skill(
        self, crafting_manager, basic_recipe
    ):
    ...
    async def test_get_available_recipes(self, crafting_manager, basic_recipe):
        ...
        recipes = await crafting_manager.get_available_recipes(
            "player1", available_components
        )
    ...
    @pytest.mark.asyncio
    async def test_get_available_recipes_insufficient_requirements(
        self, crafting_manager, basic_recipe
    ):
    ...
    @pytest.mark.asyncio
    async def test_enhance_crafting_with_modifiers(
        self, crafting_manager, basic_recipe
    ):
        ...
        result = await crafting_manager.enhance_crafting_with_modifiers(
            session_id, modifiers
        )
    ...
    async def test_register_crafting_station(self, crafting_manager):
        ...
        assert (
            crafting_manager._crafting_stations["master_forge"] == station_capabilities
        )
