...
class TestPhysicsConstraintEngine:
    ...
    @pytest.mark.asyncio
    async def test_validate_physical_constraints_success(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_calculate_strength_requirements_different_actions(self, physics_engine):
    ...
    @pytest.mark.asyncio
    async def test_calculate_energy_expenditure(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_calculate_energy_expenditure_different_actions(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_check_balance_and_stability_stable(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_check_balance_and_stability_challenging(self, physics_engine, sample_player_state):
    ...
    async def test_apply_gravity_effects_support_failure(self, physics_engine):
        ...
        with patch.object(physics_engine, '_get_entity_structural_properties') as mock_props:
    ...
    def test_register_constraint_rule(self, physics_engine):
        ...
        physics_engine.register_constraint_rule("custom_rule", mock_validator, priority=7)
    ...
    @pytest.mark.asyncio
    async def test_mass_limit_validation_success(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_energy_requirements_validation_success(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_spatial_clearance_validation(self, physics_engine, sample_player_state):
    ...
    @pytest.mark.asyncio
    async def test_balance_requirements_validation(self, physics_engine, sample_player_state):
    ...
    def test_calculate_mass_factor(self, physics_engine):
        ...
        movement_factor = physics_engine._calculate_mass_factor(PhysicalActionType.MOVEMENT, 50.0)
        pushing_factor = physics_engine._calculate_mass_factor(PhysicalActionType.PUSHING, 50.0)
        climbing_factor = physics_engine._calculate_mass_factor(PhysicalActionType.CLIMBING, 50.0)
    ...
    def test_environmental_resistance_calculation(self, physics_engine):
        ...
        # All should be positive
        assert all(r > 0 for r in [normal_resistance, underwater_resistance, icy_resistance])
    ...
    def test_collision_damage_calculation(self, physics_engine):
        ...
        low_damage = physics_engine._calculate_collision_damage("entity", 150.0, entity_props)
        high_damage = physics_engine._calculate_collision_damage("entity", 350.0, entity_props)
...
async def test_physics_engine_integration():
    ...
    strength_req = await physics_engine.calculate_strength_requirements(
        PhysicalActionType.CLIMBING, 15.0, {"leverage_factor": 1.5}  # Rope provides leverage
    )
