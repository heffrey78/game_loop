...
class TestContainerManager:
    ...
    @pytest.mark.asyncio
    async def test_create_container_success(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_create_container_duplicate_id(self, container_manager, basic_container_spec):
        ...
        success = await container_manager.create_container("test_container", basic_container_spec)
        
        assert success is False

    @pytest.mark.asyncio
    async def test_open_container_success(self, container_manager, basic_container_spec):
        """Test successful container opening."""
        await container_manager.create_container("test_container", basic_container_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_open_container_access_denied(self, container_manager, basic_container_spec):
        ...
        await container_manager.create_container("private_container", private_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_open_container_already_open(self, container_manager, basic_container_spec):
        ...
        # Try to open again
        success, result = await container_manager.open_container("test_container", "owner", {})
    ...
    @pytest.mark.asyncio
    async def test_place_item_in_container(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_place_item_container_closed(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_retrieve_item_from_container(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_organize_container_contents(self, container_manager, basic_container_spec):
        """Test container content organization."""
        await container_manager.create_container("test_container", basic_container_spec, "owner")
        
        result = await container_manager.organize_container_contents("test_container", "auto")
        
        assert "error" not in result
        assert result["strategy"] == "auto"

    @pytest.mark.asyncio
    async def test_get_container_hierarchy(self, container_manager, basic_container_spec):
        """Test getting container hierarchy."""
        await container_manager.create_container("root_container", basic_container_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_search_container_contents(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_search_container_contents_recursive(self, container_manager, basic_container_spec):
        """Test recursive container content search."""
        await container_manager.create_container("parent_container", basic_container_spec, "owner")
        await container_manager.create_container("child_container", basic_container_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_validate_container_access_owner(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_validate_container_access_non_owner(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_apply_container_effects_preservation(self, container_manager, basic_container_spec):
        """Test applying preservation effects to container."""
        await container_manager.create_container("magic_container", basic_container_spec, "owner")
        
        result = await container_manager.apply_container_effects(
            "magic_container",
            "preservation",
            {"power": 2.0, "time_elapsed": 1.0}
        )
    ...
    @pytest.mark.asyncio
    async def test_apply_container_effects_temperature(self, container_manager, basic_container_spec):
        """Test applying temperature control effects."""
        await container_manager.create_container("cooling_box", basic_container_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_transfer_between_containers(self, container_manager, basic_container_spec):
        """Test transferring items between containers."""
        await container_manager.create_container("container1", basic_container_spec, "owner")
        await container_manager.create_container("container2", basic_container_spec, "owner")
    ...
    @pytest.mark.asyncio
    async def test_container_access_logging(self, container_manager, basic_container_spec):
        """Test that container access is logged."""
        await container_manager.create_container("test_container", basic_container_spec, "owner")
        
        # Open container
        await container_manager.open_container("test_container", "owner", {"test": "context"})
    ...
    @pytest.mark.asyncio
    async def test_container_organization_strategies(self, container_manager, basic_container_spec):
        ...
        for strategy in strategies:
            result = await container_manager.organize_container_contents("test_container", strategy)
            assert result["strategy"] == strategy
            assert "changes_made" in result

    @pytest.mark.asyncio
    async def test_container_metadata_tracking(self, container_manager, basic_container_spec):
        ...
        assert "created_at" in container_data  # created_at is in main container data, not metadata
        assert "access_count" in container_data["metadata"]
        assert container_data["metadata"]["organization_strategy"] == "auto"

    @pytest.mark.asyncio
    async def test_container_access_count_tracking(self, container_manager, basic_container_spec):
    ...
    @pytest.mark.asyncio
    async def test_container_hierarchy_depth_limit(self, container_manager, basic_container_spec):
    ...
    async def test_error_handling_invalid_container(self, container_manager):
        ...
        success, result = await container_manager.open_container("nonexistent", "user", {})
        
        assert success is False
        assert "not found" in result["error"]

    @pytest.mark.asyncio
    async def test_container_state_persistence(self, container_manager, basic_container_spec):
