...
class TestNPCThemeManager:
    ...
    def test_default_archetypes_loaded(self, theme_manager):
        ...
        expected_archetypes = [
            "merchant", "guard", "scholar", "hermit", 
            "innkeeper", "artisan", "wanderer"
        ]
    ...
    @pytest.mark.asyncio
    async def test_determine_npc_archetype_populate_location(self, theme_manager, sample_location, sample_location_theme):
    ...
    @pytest.mark.asyncio
    async def test_determine_npc_archetype_quest_related(self, theme_manager, sample_location, sample_location_theme):
    ...
    @pytest.mark.asyncio
    async def test_validate_npc_consistency_good_match(self, theme_manager, sample_location):
        ...
        personality = NPCPersonality(
            name="Village Trader",
            archetype="merchant",
            traits=["persuasive", "business-minded", "social"],  # Matches merchant archetype
    ...
    async def test_get_personality_template_unknown_archetype(self, theme_manager):
        ...
        template = await theme_manager.get_personality_template("unknown_type", "Village")
    ...
    def test_generate_contextual_fears_merchant_city(self, theme_manager):
        ...
        assert any(fear in ["theft", "bad_reputation", "market_crash"] for fear in fears)
