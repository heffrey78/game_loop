...
class TestRuleTrigger:
    ...
    def test_trigger_with_condition(self):
        ...
        trigger = RuleTrigger(
            ...
            condition=health_low_condition
        )
...
class TestRuleTriggerManager:
    ...
    def test_manager_has_default_triggers(self, trigger_manager):
        ...
        action_triggers = trigger_manager.get_triggers_by_type(TriggerType.ACTION_PERFORMED)
    ...
    def test_add_custom_trigger(self, trigger_manager):
        ...
        assert custom_trigger in trigger_manager._triggers_by_type[TriggerType.CUSTOM_EVENT]
    ...
    def test_remove_trigger(self, trigger_manager):
        ...
        assert custom_trigger not in trigger_manager._triggers_by_type[TriggerType.CUSTOM_EVENT]
...
class TestEventProcessing:
    ...
    def test_process_health_change_event(self, trigger_manager):
        ...
        health_triggers = trigger_manager.get_triggers_by_type(TriggerType.HEALTH_CHANGED)
