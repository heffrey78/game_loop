...
class TestRuleAction:
    ...
    def test_action_serialization(self):
        ...
        action = RuleAction(
            action_type=ActionType.GRANT_REWARD, parameters={"experience": 100}
        )
...
class TestRule:
    ...
    def test_rule_with_conditions_and_actions(self):
        ...
        action = RuleAction(
            action_type=ActionType.SEND_MESSAGE, parameters={"message": "Low health!"}
        )
...
class TestRuleEvaluationContext:
    ...
    def test_get_value_simple_path(self):
        ...
        context = RuleEvaluationContext(player_state={"health": 75})
    ...
    def test_get_value_nonexistent_path(self):
        ...
        context = RuleEvaluationContext(player_state={"health": 100})
...
class TestRuleResult:
    ...
    def test_result_string_representation(self):
        ...
        rule_id = uuid4()
        result = RuleResult(
            rule_id=rule_id, rule_name="test_rule", triggered=True, conditions_met=True
        )
