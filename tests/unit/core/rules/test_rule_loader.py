    ...
    def test_load_from_dict_multiple_rules(self, loader):
        ...
        rules_data = {
            "rules": [
                {
                    "name": "rule1",
                    "conditions": [{"field": "test1", "operator": "equals", "value": "test"}],
                    "actions": [{"type": "send_message", "parameters": {}}]
                },
                {
                    "name": "rule2",
                    "conditions": [{"field": "test2", "operator": "equals", "value": "test"}],
                    "actions": [{"type": "send_message", "parameters": {}}]
                }
            ]
        }
    ...
    def test_create_sample_yaml_file(self, loader):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.yaml', delete=False) as f:
            try:
                ...
                health_rule = next((r for r in rules if r.name == "low_health_warning"), None)
