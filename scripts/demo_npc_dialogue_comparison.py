...
async def demo_dialogue():
    ...
    console.print("• [red]Old:[/red] Fixed responses based on dialogue state (neutral/friendly/hostile)")
    ...
    console.print()
    console.print("• [green]New:[/green] Dynamic responses generated based on NPC role and location")
    console.print("• [green]New:[/green] Personality traits influence behavior (serious, cautious, professional)")
    console.print("• [green]New:[/green] Provides useful local knowledge about the area")
    console.print("• [green]New:[/green] Can discuss multiple topics (security, building layout, etc.)")
    console.print("• [green]New:[/green] Adapts to player's exploration style and experience level")
